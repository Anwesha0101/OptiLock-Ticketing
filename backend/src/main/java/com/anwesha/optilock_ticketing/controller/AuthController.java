...
import com.anwesha.optilock_ticketing.service.AuthService;
...
/**
 * Public authentication endpoints - registration and login. Both
 * delegate entirely to AuthService and return a signed JWT on success.
 */
@RestController
